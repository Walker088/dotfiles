...
export PATH=$PATH:/usr/local/bin/bowtie2-2.2.4
...
# settings for sratools/fastq-dump
export LD_LIBRARY_PATH=/usr/local/ncbi/ncbi-vdb/lib64:/usr/local/ncbi/ncbi-vdb/lib64:
